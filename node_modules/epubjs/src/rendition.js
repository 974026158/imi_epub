...
class Rendition {
	constructor(book, options) {
		...
		//新建队列用来存放渲染task,隊列第一個任務被添加進來就自動運行，其他任務等待依次運行
	...
	*/
	 ...
	 */
	next(moveLength){
		return this.q.enqueue(this.manager.next.bind(this.manager,moveLength))
	 ...
	 */
	prev(moveLength){
		return this.q.enqueue(this.manager.prev.bind(this.manager,moveLength))
			.then(this.reportLocation.bind(this));
	}
