...
// IframeView类，以Iframe形式展示内容的view 视图区
class IframeView {
	...
	render(request, show) {
		...
		return this.sectionRender
			.then(function(contents){
				...
				//给css增加钩子函数
				return this.hooks.content.trigger(this.iframe);
            }.bind(this))
			.then(function(){
	...
	reframe(width, height) {
		...
		if(isNumber(height)){
			this.element.style.height = (height-46) + "px";
			this.iframe.style.height = (height-46) + "px";
			this._height = height-46;
		}

		let widthDelta =  width;
		let heightDelta = height;
	...
	highlight(cfiRange, data={}, cb, className = "epubjs-hl", styles = {}) {
		...
		h.element.addEventListener("click", function (e){
			e.stopPropagation();
            emitter();
		});
		h.element.addEventListener("touchstart", function () {
            e.stopPropagation();
            emitter();
        });
		...
		if (cb) {
			...
			h.element.addEventListener("touchstart", function (e) {
                e.stopPropagation();
                cb(e);
            });
		}
